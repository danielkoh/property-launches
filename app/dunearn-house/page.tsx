...
export default function DunearnHousePage() {
  ...
  return (
    <div className="min-h-screen bg-[#FAFBFD] text-[#111418] font-inter pb-24 dark:bg-background-dark dark:text-white">
      {/* Hero Section */}
      <section className="relative w-full h-[60vh] md:h-[75vh] flex items-end pb-12 overflow-hidden">
      ...
      <section id="overview" className="px-6 py-12 max-w-5xl mx-auto relative z-20">
        <div className="bg-white dark:bg-gray-800 rounded-3xl p-6 md:p-8 shadow-xl border border-gray-100 dark:border-gray-700 flex flex-wrap md:flex-nowrap gap-6 justify-between items-center text-center">
          <div className="flex-1 min-w-[45%] md:min-w-0">
            ...
            <h3 className="font-bold text-xl dark:text-white">380 Units</h3>
            <p className="text-sm text-gray-500 dark:text-gray-400">Exclusive & Private</p>
          </div>
          <div className="hidden md:block w-px h-16 bg-gray-200 dark:bg-gray-700"></div>
          <div className="flex-1 min-w-[45%] md:min-w-0">
            <span className="material-symbols-outlined text-primary text-4xl mb-2">train</span>
            <h3 className="font-bold text-xl dark:text-white">4-Min Walk</h3>
            <p className="text-sm text-gray-500 dark:text-gray-400">Sixth Avenue MRT (DTL)</p>
          </div>
          <div className="hidden md:block w-px h-16 bg-gray-200 dark:bg-gray-700"></div>
          <div className="flex-1 min-w-[45%] md:min-w-0">
            <span className="material-symbols-outlined text-primary text-4xl mb-2">school</span>
            <h3 className="font-bold text-xl dark:text-white">Elite Belt</h3>
            <p className="text-sm text-gray-500 dark:text-gray-400">MGS & Nanyang Primary</p>
          </div>
          <div className="hidden md:block w-px h-16 bg-gray-200 dark:bg-gray-700"></div>
          <div className="flex-1 min-w-[45%] md:min-w-0">
            <span className="material-symbols-outlined text-primary text-4xl mb-2">trending_up</span>
            <h3 className="font-bold text-xl dark:text-white">First-Mover</h3>
            <p className="text-sm text-gray-500 dark:text-gray-400">Turf City Transformation</p>
          </div>
        </div>
      </section>
      ...
      <section className="px-6 py-6 max-w-5xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          {/* Details Column */}
          <div className="lg:col-span-7 bg-white dark:bg-gray-800 p-6 md:p-8 rounded-3xl shadow-xl border border-gray-100 dark:border-gray-700 h-full">
            <h3 className="text-2xl font-bold mb-6 flex items-center gap-3 text-slate-800 dark:text-white">
              <span className="material-symbols-outlined text-primary text-3xl">info</span> Project Fact Sheet
            </h3>
      ...
      <section id="location-schools" className="px-6 py-16 max-w-5xl mx-auto scroll-mt-20">
        <div className="mb-10">
          <div className="flex items-center gap-2 text-primary mb-2">
            <span className="material-symbols-outlined">location_on</span>
            <span className="text-sm font-bold uppercase tracking-widest">Connectivity & Schools</span>
          </div>
          <h2 className="text-3xl font-black tracking-tight">Elite Education Belt & Smart Transit Hub</h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center mb-12">
          <div className="md:col-span-6 flex flex-col gap-6">
            ...
            <div className="bg-[#f0f4f8] dark:bg-slate-900/60 p-6 rounded-2xl border-l-4 border-primary">
      ...
      <section id="growth-nature" className="px-6 py-20 bg-slate-50 dark:bg-background-dark/30 border-y border-gray-100 dark:border-gray-800 scroll-mt-20">
        <div className="max-w-5xl mx-auto">
          <div className="mb-10">
            <div className="flex items-center gap-2 text-primary mb-2">
              <span className="material-symbols-outlined">park</span>
              <span className="text-sm font-bold uppercase tracking-widest">Growth & Nature</span>
            </div>
            <h2 className="text-3xl font-black tracking-tight">The Bukit Timah Turf City Transformation</h2>
          </div>
      ...
      <section id="price-advantage" className="px-6 py-20 max-w-5xl mx-auto scroll-mt-20">
        <div className="mb-10 text-center max-w-3xl mx-auto">
          <div className="inline-flex items-center gap-2 text-primary mb-2">
            <span className="material-symbols-outlined">trending_up</span>
            <span className="text-sm font-bold uppercase tracking-widest">Entry-Price Math</span>
          </div>
          <h2 className="text-3xl font-black tracking-tight">The Land Cost Advantage</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center mb-12">
          <div className="lg:col-span-7 flex flex-col gap-6">
            <div className="bg-white dark:bg-gray-800 p-6 md:p-8 rounded-3xl shadow-xl border border-gray-100 dark:border-gray-700">
            ...
            <div className="bg-[#FAFBFD] dark:bg-slate-900/60 p-6 rounded-2xl border border-gray-200 dark:border-gray-700">
              <h4 className="font-bold text-slate-800 dark:text-white text-sm mb-3">Early 2026 Comparable Transactions (D10/11)</h4>
              <div className="overflow-x-auto">
                <table className="w-full text-left text-xs text-gray-500 dark:text-gray-300">
                  ...
                  <tbody className="divide-y divide-gray-100 dark:divide-gray-800 font-medium">
                    <tr>
                      <td className="py-2.5 text-slate-800 dark:text-white">The Tessarina</td>
                      <td className="py-2.5">$4,118,000</td>
                      <td className="py-2.5">1,615</td>
                      <td className="py-2.5 text-primary font-black">$2,550</td>
                    </tr>
                    <tr>
                      <td className="py-2.5 text-slate-800 dark:text-white">Fourth Avenue Res.</td>
                      <td className="py-2.5">$3,050,000</td>
                      <td className="py-2.5">1,119</td>
                      <td className="py-2.5 text-primary font-black">$2,726</td>
                    </tr>
                    <tr>
                      <td className="py-2.5 text-slate-800 dark:text-white">The Sixth Avenue Res.</td>
                      <td className="py-2.5">$3,200,000</td>
                      <td className="py-2.5">1,356</td>
                      <td className="py-2.5 text-primary font-black">$2,360</td>
                    </tr>
                    <tr>
                      <td className="py-2.5 text-slate-800 dark:text-white">Sixth Avenue Ville</td>
                      <td className="py-2.5">$3,508,000</td>
                      <td className="py-2.5">1,755</td>
                      <td className="py-2.5 text-primary font-black">$1,999</td>
                    </tr>
                  </tbody>
                </table>
              </div>
              <p className="text-[10px] text-gray-400 mt-3 italic">*Data retrieved from real transaction records; for educational illustration.</p>
            </div>
          </div>
          <div className="lg:col-span-5 flex flex-col gap-6">
            <div className="rounded-2xl overflow-hidden shadow-xl bg-white border border-gray-100 dark:border-gray-700 aspect-[4/3]">
      ...
      {/* Section: Developers */}
      <section id="developers" className="px-6 py-20 bg-slate-50 dark:bg-background-dark/30 border-t border-gray-100 dark:border-gray-800 scroll-mt-20">
        <div className="max-w-5xl mx-auto">
          <div className="mb-10 text-center">
            <div className="inline-flex items-center gap-2 text-primary mb-2">
              <span className="material-symbols-outlined">domain</span>
              <span className="text-sm font-bold uppercase tracking-widest">Developer Track Record</span>
            </div>
            <h2 className="text-3xl font-black tracking-tight">Phoenix Dunearn Consortium</h2>
            <p className="text-gray-500 mt-2">A high-performance partnership of three industry leading builders.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 flex flex-col justify-between">
              <div>
                <h4 className="font-extrabold text-lg mb-2 text-slate-800 dark:text-white">Frasers Property</h4>
                ...
                <div className="flex flex-wrap gap-1.5">
                  {['Riviere', 'Sky Eden@Bedok', 'The Orie'].map((p) => (
                    <span key={p} className="text-[10px] bg-slate-100 dark:bg-slate-900 text-slate-600 dark:text-slate-300 px-2 py-1 rounded">
                      {p}
                    </span>
                  ))}
                </div>
              ...
              <div className="mt-6 pt-4 border-t border-gray-100 dark:border-gray-700">
                <img src="/dunearn-house/page_13.jpg" alt="Frasers Track Record" className="w-full h-24 object-cover rounded-lg" loading="lazy" />
              </div>
            </div>

            <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 flex flex-col justify-between">
              <div>
                <h4 className="font-extrabold text-lg mb-2 text-slate-800 dark:text-white">CSC Land Group</h4>
                <p className="text-xs text-gray-500 dark:text-gray-400 leading-relaxed mb-4">
              ...
              <div className="mt-6 pt-4 border-t border-gray-100 dark:border-gray-700">
                <img src="/dunearn-house/page_14.jpg" alt="CSC Track Record" className="w-full h-24 object-cover rounded-lg" loading="lazy" />
              </div>
            </div>

            <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 flex flex-col justify-between">
              <div>
                <h4 className="font-extrabold text-lg mb-2 text-slate-800 dark:text-white">Sekisui House</h4>
                <p className="text-xs text-gray-500 dark:text-gray-400 leading-relaxed mb-4">
              ...
              <div className="mt-6 pt-4 border-t border-gray-100 dark:border-gray-700">
                <img src="/dunearn-house/page_15.jpg" alt="Sekisui Track Record" className="w-full h-24 object-cover rounded-lg" loading="lazy" />
              </div>
            </div>
          </div>

          <div className="flex flex-col sm:flex-row gap-6 items-center bg-white dark:bg-gray-800 p-6 rounded-2xl border border-gray-100 dark:border-gray-700">
            ...
            <div className="sm:w-2/3">
              <h4 className="font-bold text-sm mb-1 text-slate-800 dark:text-white">Strict Construction Delivery</h4>
      ...
      <section className="px-6 py-16 max-w-5xl mx-auto">
        <div className="bg-white dark:bg-gray-800 rounded-3xl p-8 shadow-xl border border-gray-100 dark:border-gray-700 text-center">
          <h3 className="text-2xl font-black mb-4">Core Selling Points Summary</h3>
      ...
      {/* Register Section */}
      <section
        className="py-24 px-4 md:px-10 lg:px-40 bg-[#0e141b] relative overflow-hidden"
        id="register"
      >
        ...
        <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center max-w-6xl mx-auto">
            <div className="text-white">
                <span className="inline-block bg-primary text-white text-[10px] font-black uppercase px-2 py-0.5 rounded mb-4">
                  VVIP Launch Phase
                </span>
